...
##############################################################
#
# Ask questions to prepare cloud-init file for mini pupper with Stanford controller
#
...
conf_file = os.path.join(os.path.expanduser("~"), '.mp_stanford_sd.txt')
...
- git
runcmd:
- [ su, ubuntu, -c, "git clone https://github.com/mangdangroboticsclub/StanfordQuadruped.git /home/ubuntu/StanfordQuadruped" ]
